      ...
      <div className="container">
        <div className="rb-12 mb-12 md:mb-18 lg:mb-20">
          <h2 className="rb-5 mb-5 text-5xl font-bold md:mb-6 md:text-7xl lg:text-8xl">
            Unsere Looks – Ihre Inspiration
          </h2>
          <p className="md:text-md">
            Entdecken Sie aktuelle Frisuren, Farbtrends und Stylings direkt aus
            unserem Salon. Echte Kundinnen. Echte Ergebnisse. Echte Veränderung.
          </p>
        </div>
        <Carousel
