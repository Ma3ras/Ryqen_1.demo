    ...
    >
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">Echte Meinungen – echte Ergebnisse</p>
        </div>
        <Carousel
          ...
          <div className="relative">
            <CarouselContent className="ml-0 md:mx-3.5">
              <CarouselItem className="pl-0 md:basis-1/2 md:px-4 lg:basis-1/3">
                <div className="flex w-full flex-col items-start justify-between p-6 md:p-8 bg-white rounded-lg shadow-md">
                  ...
                  <p className="md:text-md">
                    "Der beste Friseur in der Stadt!"
                  </p>
