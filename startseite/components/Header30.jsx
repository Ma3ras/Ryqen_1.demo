        ...
        <div className="flex max-h-[60rem] min-h-svh items-center justify-center py-16 text-center md:py-24 lg:py-28">
          <div className="w-full max-w-lg">
            ...
            <div className="mt-6 flex items-center justify-center gap-x-4 md:mt-8">
              <button className="rounded-lg bg-[#2E2E2E] px-6 py-3 text-sm font-medium text-white hover:bg-[#404040] transition-colors">
                Jetzt Termin buchen
              </button>
              <button className="rounded-lg bg-white px-6 py-3 text-sm font-medium text-gray-800 hover:bg-gray-100 transition-colors">
                Mehr erfahren
              </button>
            </div>
          </div>
